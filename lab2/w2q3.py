...
print("Average times:")
print("DES Encryption",(des_enc_time/iter)*1_000_000,"microseconds")
print("DES Decryption",(des_dec_time/iter)*1_000_000,"microseconds")
print("AES Encryption",(aes_enc_time/iter)*1_000_000,"microseconds")
print("AES decryption",(aes_dec_time/iter)*1_000_000,"microseconds")
print("\nVERIFICATION")
if des_pt == msg:
...
#ON AVERAGE- AES ENCRYPTION AND DECRYPTION IS FASTER THAN DES